...
class SettingsDefault(object):
    def __init__(self, db):
        ...
        """Загрузка активов в таблицу по умолчанию"""
        if not self.active_helper.check_actives_in_db():
            self.active_helper.load_defaults()
    ...
    def _load_setting(self, raw):
        ...
        self.trader_delay_on_trend = raw[15]
        self.trader_max_count_orders_for_expiration_time = raw[16]
