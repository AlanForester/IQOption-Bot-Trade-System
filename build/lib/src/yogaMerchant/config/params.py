...
class Params(object):
    ...
    def set_analyzer_prediction_save_if_exists(self, save_if_exists):
        self._analyzer_settings[config_constants.ANALYZER_PREDICTION_SAVE_IF_EXISTS] = save_if_exists

    def get_analyzer_prediction_save_if_exists(self):
        return self._analyzer_settings[config_constants.ANALYZER_PREDICTION_SAVE_IF_EXISTS]
    ...
    def set_trader_max_bids_for_expiration_time(self, count):
        self._trader_settings[config_constants.TRADER_MAX_BIDS_FOR_EXPIRATION_TIME] = count

    def get_trader_max_bids_for_expiration_time(self):
        return self._trader_settings[config_constants.TRADER_MAX_BIDS_FOR_EXPIRATION_TIME]
